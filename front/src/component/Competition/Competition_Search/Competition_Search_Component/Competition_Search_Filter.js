...
export default function Competition_Schedule_Filter(props){
    ...
    return(
        <Box sx={{position:"fixed",backgroundColor:'#ffffff',zIndex:1000,top:'60px',display:'flex',justifyContent:'start',alignItems:'center',height:'30px',borderColor:'#E8E8E8',width:'100%',height:'50px',minWidth:'360px',maxWidth:'420px'}}>
